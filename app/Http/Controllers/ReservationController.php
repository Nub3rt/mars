...
class ReservationController extends Controller
{
    ...
    {
        return response()->json(Reservation::where('reservable_item_id', $item->id)->orderBy('reserved_from')-get());
    }
    ...
    public function indexForWashingMachines()
    {
        $machines = ReservableItem::where('type', 'washing_machine')
            ...
            return ['reservable_item' => $machine,
                    'reservations'    => Reservations::where('reservable_item_id', $machine->id)
    ...
    {
        abort(500, 'Creating reservation not implemented yet');
    }

    /**
     * Stores a reservation based on
     * a ReservabeItem provided separately
